...
/*******************************************************************************
* Function Name: Scope0_Comp_Clock_Start
********************************************************************************
*
* Summary:
...
void Scope0_Comp_Clock_Start(void) 
{
    ...
    Scope0_Comp_Clock_CLKEN |= Scope0_Comp_Clock_CLKEN_MASK;
	Scope0_Comp_Clock_CLKSTBY |= Scope0_Comp_Clock_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: Scope0_Comp_Clock_Stop
********************************************************************************
*
* Summary:
...
void Scope0_Comp_Clock_Stop(void) 
{
    ...
    Scope0_Comp_Clock_CLKEN &= (uint8)(~Scope0_Comp_Clock_CLKEN_MASK);
	Scope0_Comp_Clock_CLKSTBY &= (uint8)(~Scope0_Comp_Clock_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: Scope0_Comp_Clock_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((Scope0_Comp_Clock_CLKEN & Scope0_Comp_Clock_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = Scope0_Comp_Clock_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = Scope0_Comp_Clock_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* Scope0_Comp_Clock__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(Scope0_Comp_Clock_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(Scope0_Comp_Clock_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: Scope0_Comp_Clock_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Scope0_Comp_Clock_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = Scope0_Comp_Clock_GetSourceRegister();
    uint16 oldDivider = Scope0_Comp_Clock_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = Scope0_Comp_Clock_CLKEN & Scope0_Comp_Clock_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(Scope0_Comp_Clock_DIV_PTR, clkDivider);
                Scope0_Comp_Clock_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                Scope0_Comp_Clock_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(Scope0_Comp_Clock_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((Scope0_Comp_Clock_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
            ...
            else
            {
                ...
                CY_SET_REG16(Scope0_Comp_Clock_DIV_PTR, clkDivider);
				Scope0_Comp_Clock_CLKEN |= enabled;
            }
        }
    }
}
...
/*******************************************************************************
* Function Name: Scope0_Comp_Clock_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(Scope0_Comp_Clock_DIV_PTR);
}


/*******************************************************************************
* Function Name: Scope0_Comp_Clock_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    Scope0_Comp_Clock_MOD_SRC |= modeBitMask & (uint8)Scope0_Comp_Clock_MODE_MASK;
}


/*******************************************************************************
* Function Name: Scope0_Comp_Clock_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    Scope0_Comp_Clock_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(Scope0_Comp_Clock_MODE_MASK));
}


/*******************************************************************************
* Function Name: Scope0_Comp_Clock_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return Scope0_Comp_Clock_MOD_SRC & (uint8)(Scope0_Comp_Clock_MODE_MASK);
}


/*******************************************************************************
* Function Name: Scope0_Comp_Clock_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = Scope0_Comp_Clock_GetDividerRegister();
    uint8 oldSrc = Scope0_Comp_Clock_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        Scope0_Comp_Clock_MOD_SRC |= CYCLK_SSS;
        Scope0_Comp_Clock_MOD_SRC =
            (Scope0_Comp_Clock_MOD_SRC & (uint8)(~Scope0_Comp_Clock_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: Scope0_Comp_Clock_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return Scope0_Comp_Clock_MOD_SRC & Scope0_Comp_Clock_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: Scope0_Comp_Clock_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    Scope0_Comp_Clock_PHASE = clkPhase & Scope0_Comp_Clock_PHASE_MASK;
}


/*******************************************************************************
* Function Name: Scope0_Comp_Clock_GetPhase
********************************************************************************
*
* Summary:
...
{
    return Scope0_Comp_Clock_PHASE & Scope0_Comp_Clock_PHASE_MASK;
}
