...
{
	WaveDAC_0_VDAC8_Init();
	WaveDAC_0_VDAC8_SetSpeed(WaveDAC_0_HIGHSPEED);
	WaveDAC_0_VDAC8_SetRange(WaveDAC_0_DAC_RANGE);

	#if(WaveDAC_0_DAC_MODE == WaveDAC_0_CURRENT_MODE)
		WaveDAC_0_IDAC8_SetPolarity(WaveDAC_0_DAC_POL);
	#endif /* WaveDAC_0_DAC_MODE == WaveDAC_0_CURRENT_MODE */

	#if(WaveDAC_0_OUT_MODE == WaveDAC_0_BUFFER_MODE)
	   WaveDAC_0_BuffAmp_Init();
	#endif /* WaveDAC_0_OUT_MODE == WaveDAC_0_BUFFER_MODE */

	/* Get the TD Number for the DMA channel 1 and 2   */
	WaveDAC_0_Wave1TD = CyDmaTdAllocate();
	WaveDAC_0_Wave2TD = CyDmaTdAllocate();
	
	/* Initialize waveform pointers  */
	WaveDAC_0_Wave1Setup(WaveDAC_0_wave1, WaveDAC_0_WAVE1_LENGTH) ;
	WaveDAC_0_Wave2Setup(WaveDAC_0_wave2, WaveDAC_0_WAVE2_LENGTH) ;
	
	/* Initialize the internal clock if one present  */
	#if defined(WaveDAC_0_DacClk_PHASE)
	   WaveDAC_0_DacClk_SetPhase(WaveDAC_0_CLK_PHASE_0nS);
	#endif /* defined(WaveDAC_0_DacClk_PHASE) */
}


/*******************************************************************************
* Function Name: WaveDAC_0_Enable
********************************************************************************
*  
* Summary: 
...
{
	WaveDAC_0_VDAC8_Enable();

	#if(WaveDAC_0_OUT_MODE == WaveDAC_0_BUFFER_MODE)
	   WaveDAC_0_BuffAmp_Enable();
	#endif /* WaveDAC_0_OUT_MODE == WaveDAC_0_BUFFER_MODE */
	...
	*/
	(void)CyDmaChEnable(WaveDAC_0_Wave1Chan, 1u);
	(void)CyDmaChEnable(WaveDAC_0_Wave2Chan, 1u);
	
	/* set the initial value */
	WaveDAC_0_SetValue(0u);
	
	#if(WaveDAC_0_CLOCK_SRC == WaveDAC_0_CLOCK_INT)  	
	   WaveDAC_0_DacClk_Start();
	#endif /* WaveDAC_0_CLOCK_SRC == WaveDAC_0_CLOCK_INT */
}


/*******************************************************************************
* Function Name: WaveDAC_0_Start
********************************************************************************
*
* Summary:
...
void WaveDAC_0_Start(void) 
{
	...
	if(WaveDAC_0_initVar == 0u)
	{
		WaveDAC_0_Init();
		WaveDAC_0_initVar = 1u;
	}
...
/*******************************************************************************
* Function Name: WaveDAC_0_StartEx
********************************************************************************
*
* Summary:
...
{
	WaveDAC_0_Wave1Setup(wavePtr1, sampleSize1);
	WaveDAC_0_Wave2Setup(wavePtr2, sampleSize2);
	WaveDAC_0_Start();
}


/*******************************************************************************
* Function Name: WaveDAC_0_Stop
********************************************************************************
*
* Summary:
...
void WaveDAC_0_Stop(void) 
{
	...
	#if(WaveDAC_0_CLOCK_SRC == WaveDAC_0_CLOCK_INT)  	
	   WaveDAC_0_DacClk_Stop();
	#endif /* WaveDAC_0_CLOCK_SRC == WaveDAC_0_CLOCK_INT */
	
	/* Disble DMA channels */
	(void)CyDmaChDisable(WaveDAC_0_Wave1Chan);
	(void)CyDmaChDisable(WaveDAC_0_Wave2Chan);

	/* Disable power to DAC */
	WaveDAC_0_VDAC8_Stop();
}


/*******************************************************************************
* Function Name: WaveDAC_0_Wave1Setup
********************************************************************************
*
* Summary:
...

{
		...
		memoryType = (WaveDAC_0_HI16FLASHPTR == HI16(wavePtr)) ? HI16(CYDEV_FLS_BASE) : HI16(CYDEV_SRAM_BASE);
		
		WaveDAC_0_Wave1Chan = WaveDAC_0_Wave1_DMA_DmaInitialize(
		WaveDAC_0_Wave1_DMA_BYTES_PER_BURST, WaveDAC_0_Wave1_DMA_REQUEST_PER_BURST,
		memoryType, HI16(CYDEV_PERIPH_BASE));
	#else /* PSoC 5 */
		WaveDAC_0_Wave1Chan = WaveDAC_0_Wave1_DMA_DmaInitialize(
		WaveDAC_0_Wave1_DMA_BYTES_PER_BURST, WaveDAC_0_Wave1_DMA_REQUEST_PER_BURST,
		HI16(wavePtr), HI16(WaveDAC_0_DAC8__D));
	#endif /* CY_PSOC3 */
	...
	*/
	(void)CyDmaTdSetConfiguration(WaveDAC_0_Wave1TD, sampleSize, WaveDAC_0_Wave1TD, 
                                    (uint8)CY_DMA_TD_INC_SRC_ADR | (uint8)WaveDAC_0_Wave1_DMA__TD_TERMOUT_EN); 
	
	/* Set the TD source and destination address */
	(void)CyDmaTdSetAddress(WaveDAC_0_Wave1TD, LO16((uint32)wavePtr), LO16(WaveDAC_0_DAC8__D));
	
	/* Associate the TD with the channel */
	(void)CyDmaChSetInitialTd(WaveDAC_0_Wave1Chan, WaveDAC_0_Wave1TD);
}


/*******************************************************************************
* Function Name: WaveDAC_0_Wave2Setup
********************************************************************************
*
* Summary:
 ...
 
{
		...
		WaveDAC_0_Wave2Chan = WaveDAC_0_Wave2_DMA_DmaInitialize(
		WaveDAC_0_Wave2_DMA_BYTES_PER_BURST, WaveDAC_0_Wave2_DMA_REQUEST_PER_BURST,
		memoryType, HI16(CYDEV_PERIPH_BASE));
	#else /* PSoC 5 */
		WaveDAC_0_Wave2Chan = WaveDAC_0_Wave2_DMA_DmaInitialize(
		WaveDAC_0_Wave2_DMA_BYTES_PER_BURST, WaveDAC_0_Wave2_DMA_REQUEST_PER_BURST,
	...
	* Increment the source address, but not the destination address. 
	*/
	(void)CyDmaTdSetConfiguration(WaveDAC_0_Wave2TD, sampleSize, WaveDAC_0_Wave2TD, 
                                    (uint8)CY_DMA_TD_INC_SRC_ADR | (uint8)WaveDAC_0_Wave2_DMA__TD_TERMOUT_EN); 
	
	/* Set the TD source and destination address */
	(void)CyDmaTdSetAddress(WaveDAC_0_Wave2TD, LO16((uint32)wavePtr), LO16(WaveDAC_0_DAC8__D));
	
	/* Associate the TD with the channel */
	(void)CyDmaChSetInitialTd(WaveDAC_0_Wave2Chan, WaveDAC_0_Wave2TD);
}
