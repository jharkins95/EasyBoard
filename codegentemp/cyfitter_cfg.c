...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 16u, 0xFEu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYREG_PRT1_DR) },	/* TD 9 */
		...
		{ 256u, 0x18u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI13_BASE) },	/* TD 23 */
		...
		{ 8u, 0x1Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_DAC2_SW0) },	/* TD 28 */
		{ 8u, 0x1Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_DAC3_SW0) },	/* TD 29 */
		...
		{ 128u, 0x32u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE) },	/* TD 49 */
		{ 128u, 0x33u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE + 0x00000080u) },	/* TD 50 */
		{ 128u, 0x34u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_ROUTE_BASE + 0x00000080u) },	/* TD 51 */
		{ 128u, 0x35u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_ROUTE_BASE) },	/* TD 52 */
		{ 128u, 0x36u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_ROUTE_BASE + 0x00000080u) },	/* TD 53 */
		{ 128u, 0x37u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P1_ROUTE_BASE + 0x00000080u) },	/* TD 54 */
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_DAC2_VAL),	/* TD 28 */
		(const void *)(BS_DAC3_VAL),	/* TD 29 */
		...
		(const void *)(BS_UDBSWITCH_0_3_VAL),	/* TD 49 */
		(const void *)(BS_UDB_1_3_HV_ROUTING_VAL),	/* TD 50 */
		(const void *)(BS_UDB_2_3_HV_ROUTING_VAL),	/* TD 51 */
		(const void *)(BS_UDBSWITCH_0_4_VAL),	/* TD 52 */
		(const void *)(BS_UDB_1_4_HV_ROUTING_VAL),	/* TD 53 */
		(const void *)(BS_UDB_2_4_HV_ROUTING_VAL),	/* TD 54 */
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_FASTCLK_PLL_P), 0x0D1Fu);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT3_AG, 0x12u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SC1_SW4, 0x45u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW0, 0xF8u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_DSM0_SW2, 0x01u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_BUS_SW0, 0x88u);
...
uint8 CYXDATA * const CYCODE WaveDAC_0_Mux__addrTable[64] = {
	...
	(uint8 CYXDATA *)CYREG_DAC3_SW0, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT3_AG, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT3_AG, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_SC1_SW4, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_OPAMP1_SW, (uint8 CYXDATA *)CYREG_OPAMP1_MX, 
	(uint8 CYXDATA *)CYREG_PRT3_AG, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT3_AG, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE WaveDAC_0_Mux__maskTable[64] = {
	0x01u, 0x00u, 
	0x02u, 0x00u, 
	0x04u, 0x00u, 
	0x08u, 0x00u, 
...
/*******************************************************************************
* Function Name: WaveDAC_0_Mux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void WaveDAC_0_Mux_Set(uint8 channel)
{
	if (channel < 32)
	{
		channel += channel;
		*WaveDAC_0_Mux__addrTable[channel] |= WaveDAC_0_Mux__maskTable[channel];
		channel++;
		*WaveDAC_0_Mux__addrTable[channel] |= WaveDAC_0_Mux__maskTable[channel];
	}
}
...
/*******************************************************************************
* Function Name: WaveDAC_0_Mux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void WaveDAC_0_Mux_Unset(uint8 channel)
{
	if (channel < 32)
	{
		channel += channel;
		*WaveDAC_0_Mux__addrTable[channel] &= (uint8)~WaveDAC_0_Mux__maskTable[channel];
		channel++;
		*WaveDAC_0_Mux__addrTable[channel] &= (uint8)~WaveDAC_0_Mux__maskTable[channel];
	}
}
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE WaveDAC_1_Mux__addrTable[64] = {
	(uint8 CYXDATA *)CYREG_PRT4_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT4_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT4_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT4_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT4_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	...
	(uint8 CYXDATA *)CYREG_PRT0_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT0_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_DAC2_SW2, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT0_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT3_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT3_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT3_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT3_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT15_AG, (uint8 CYXDATA *)CYREG_PRT15_AMUX, 
	(uint8 CYXDATA *)CYREG_PRT3_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT3_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT3_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT5_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT5_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT5_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT5_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT5_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE WaveDAC_1_Mux__maskTable[64] = {
	0x01u, 0x00u, 
	0x02u, 0x00u, 
	0x04u, 0x00u, 
	0x08u, 0x00u, 
...
/*******************************************************************************
* Function Name: WaveDAC_1_Mux_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void WaveDAC_1_Mux_Set(uint8 channel)
{
	if (channel < 32)
	{
		channel += channel;
		*WaveDAC_1_Mux__addrTable[channel] |= WaveDAC_1_Mux__maskTable[channel];
		channel++;
		*WaveDAC_1_Mux__addrTable[channel] |= WaveDAC_1_Mux__maskTable[channel];
	}
}
...
/*******************************************************************************
* Function Name: WaveDAC_1_Mux_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void WaveDAC_1_Mux_Unset(uint8 channel)
{
	if (channel < 32)
	{
		channel += channel;
		*WaveDAC_1_Mux__addrTable[channel] &= (uint8)~WaveDAC_1_Mux__maskTable[channel];
		channel++;
		*WaveDAC_1_Mux__addrTable[channel] &= (uint8)~WaveDAC_1_Mux__maskTable[channel];
	}
}
...
void cyfitter_cfg(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_B0_P5_U0_CFG27), 0xA4u);
